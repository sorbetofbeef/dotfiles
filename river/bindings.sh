...
# Mod+H and Mod+L to decrease/increase the main ratio of stacktile(1)
# riverctl map normal $mod H send-layout-cmd stacktile "main-ratio -0.05"
# riverctl map normal $mod L send-layout-cmd stacktile "main-ratio +0.05"
# 
# # Mod+Shift+H and Mod+Shift+L to increment/decrement the main count of stacktile(1)
# riverctl map normal $mod+Shift H send-layout-cmd stacktile "main-count +1"
# riverctl map normal $mod+Shift L send-layout-cmd stacktile "main-count -1"
...
do
    ...
    # riverctl map $mode None XF86AudioMute         spawn 'amixer --toggle-mute'
